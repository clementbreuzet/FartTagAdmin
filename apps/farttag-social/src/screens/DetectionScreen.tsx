...
type DetectionScreenProps = NativeStackScreenProps<RootStackParamList, 'DetectionScreen'>;
...
export const DetectionScreen = ({ navigation }: DetectionScreenProps) => {
      ...
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        <View style={styles.header}>
          ...
          <View style={styles.headerLinks}>
            <Pressable onPress={() => navigation.navigate('ProfileScreen')} style={styles.feedLink}>
              <Text style={styles.feedLinkText}>PROFIL</Text>
            </Pressable>
            <Pressable onPress={() => navigation.navigate('FartHistoryScreen')} style={styles.feedLink}>
              <Text style={styles.feedLinkText}>HISTORIQUE</Text>
            </Pressable>
            <Pressable onPress={() => navigation.navigate('HomeFeedScreen')} style={styles.feedLink}>
              <Text style={styles.feedLinkText}>FEED</Text>
            </Pressable>
          </View>
        </View>
            ...
            <>
              ...
              {showDetails ? (
                <View style={styles.details}>
                  ...
                  <DetailRow label="Origine" value="Détection automatique BLE" />
                </View>
              ) : null}
            </>
          ) : (
...
const styles = StyleSheet.create({
  ...
  feedLink: { borderColor: colors.neonCyan, borderRadius: 13, borderWidth: 1, paddingHorizontal: 14, paddingVertical: 9 },
  headerLinks: { alignItems: 'flex-end', gap: 7 },
  feedLinkText: { color: colors.neonCyan, fontSize: 9, fontWeight: '900', letterSpacing: 1 },
  ...
  statusPill: { alignItems: 'center', borderColor: colors.border, borderRadius: 13, borderWidth: 1, flexDirection: 'row', gap: 5, paddingHorizontal: 9, paddingVertical: 7 },
  ...
  primaryButton: { alignItems: 'center', backgroundColor: colors.neonGreen, borderRadius: 13, justifyContent: 'center', marginTop: 16, minHeight: 46 },
  ...
  pulse: { alignItems: 'center', borderColor: colors.neonPurple, borderRadius: 17, borderWidth: 1, height: 34, justifyContent: 'center', width: 34 },
  ...
  uploadRow: { alignItems: 'center', borderTopColor: colors.border, borderTopWidth: 1, flexDirection: 'row', justifyContent: 'space-between', marginTop: 16, paddingTop: 14 },
