...
export const ProfileOverview = ({ navigation, onTabChange }: ProfileOverviewProps) => {
    ...
    <View style={styles.safeArea}>
      ...
      >
        <View style={[styles.identityCard, { borderColor: frameColor, shadowColor: frameColor }]}>
          ...
          <Pressable
            onPress={() => navigation.navigate('PublicUserProfileScreen', {
          ...
          >
            <Text style={styles.secondaryButtonText}>VOIR LE PROFIL PUBLIC</Text>
          </Pressable>
          <Pressable
        ...
        <View style={styles.card}>
          ...
          <Pressable onPress={() => onTabChange('badges')} style={styles.inlineButton}>
        ...
        <View style={styles.card}>
          ...
          <Pressable onPress={() => onTabChange('inventory')} style={styles.inlineButton}>
            <Text style={styles.inlineButtonText}>ACCÉDER À L'INVENTAIRE</Text>
          </Pressable>
          <Pressable onPress={() => onTabChange('settings')} style={styles.inlineButton}>
            <Text style={styles.inlineButtonText}>OUVRIR LES RÉGLAGES</Text>
          </Pressable>
        </View>
...
const styles = StyleSheet.create({
  ...
  secondaryButton: { alignItems: 'center', borderColor: colors.neonCyan, borderRadius: 14, borderWidth: 1, marginTop: 10, minHeight: 46, justifyContent: 'center', width: '100%' },
  secondaryButtonText: { color: colors.neonCyan, fontSize: 9, fontWeight: '900', letterSpacing: 1 },
  historyButton: { alignItems: 'center', borderColor: colors.neonGreen, borderRadius: 14, borderWidth: 1, marginTop: 10, minHeight: 46, justifyContent: 'center', width: '100%' },
  historyButtonText: { color: colors.neonGreen, fontSize: 9, fontWeight: '900', letterSpacing: 1 },
